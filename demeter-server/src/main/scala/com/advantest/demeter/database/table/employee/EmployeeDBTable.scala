 ...
 */
final case class EmployeeDBTable()(using val system: DemeterSystem, val db: Database) extends DBTable:
  override protected type TableRowData = EmployeeDBTableRow
  override protected type TableType = EmployeeDBTableSchema
