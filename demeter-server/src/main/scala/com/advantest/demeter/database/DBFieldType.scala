...
object DBFieldType extends DBTableColumn with Serializable[DBFieldType]:
  ...
  override given columnMapper: BaseColumnType[DBFieldType] = MappedColumnType.base[DBFieldType, String](fromModel, fromField)

  override given serializeFormat: RootJsonFormat[DBFieldType] = new RootJsonFormat[DBFieldType]:
