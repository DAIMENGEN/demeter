...
object ProjectTaskPayload extends Serializable[ProjectTaskPayload] with DBTableRowFactory:
  ...
  override given serializeFormat: RootJsonFormat[ProjectTaskPayload] = new RootJsonFormat[ProjectTaskPayload]:
    ...
    override def read(json: JsValue): ProjectTaskPayload = json match
